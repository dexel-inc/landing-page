...
export default function Services({ copy }) {
  ...
  return (
    <section id="services" className="min-h-screen flex items-center justify-center py-16 md:py-24 relative">
      <div className="absolute inset-0 bg-linear-to-b from-slate-100 via-slate-50 to-slate-100 dark:from-[#050505] dark:via-black/80 dark:to-[#050505] z-0"></div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div
                    className="absolute w-full h-full backface-hidden bg-linear-to-br from-blue-100/70 via-white/90 to-white border border-blue-300/60 dark:from-blue-900/40 dark:via-zinc-900/90 dark:to-zinc-900/50 dark:border-blue-500/30 rounded-2xl overflow-hidden"
                    style={{
                      ...
                      <div className="flex-1 space-y-2 md:space-y-3">
                        {service.features.map((feature, idx) => (
                          <div key={idx} className="flex items-start gap-3 group/item">
                            <Check
                              size={18}
                              className="text-blue-500 dark:text-blue-400 mt-0.5 shrink-0 group-hover/item:scale-110 transition-transform"
                            />
