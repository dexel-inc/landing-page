                  ...
                  >
                    ...
                    <div className="p-8">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                          <h3 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white mb-1">{service.title}</h3>
                      ...
                      <p className="text-slate-600 dark:text-gray-300 text-sm leading-relaxed mb-6">{service.desc}</p>
