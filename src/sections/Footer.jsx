...
export default function Footer({whatsappNumber = "573135632235", // sin + ni espacios
                               }) {
    const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hola%20Dexel,%20quiero%20una%20cotizaci%C3%B3n`;

    return (
        <footer className="text-white bg-[#050505] pt-12 text-center justify-center align-middle flex flex-col relative z-10 w-full px-4">
            <div className="flex mt-8 flex-col justify-between items-center gap-4">
                <div className="w-full text-xl md:text-7xl font-bold">
                    <h2 className="text-4xl md:text-6xl font-black leading-tight tracking-tighter">
                        ¿Que estás
                        <span className="text-transparent bg-clip-text bg-gradient-to-r to-blue-400 from-white"> esperando?</span>
                    </h2>
                </div>
                <div className="w-44 pt-6 md:pt-0">
                    <a href={whatsappLink} target="_blank" className="bg-blue-500 justify-center text-center rounded-lg shadow md:px-10 py-3 flex items-center">Contactanos</a>
                </div>
            </div>
            <div className="flex flex-col w-full justify-center">
                <div className="flex my-2 flex-col gap-8 md:flex-row items-center md:px-10 justify-between">
                    <div className="md:mr-10 text-xl font-bold tracking-[0.2em] text-gray-300 flex flex-col align-middle">
                        <Logo className="w-30 h-30" viewBox="0 0 324 210"/>
                    </div>
                    <div className="flex flex-col md:flex-row gap-6 md:text-start">
                        <a className="cursor-pointer text-gray-600 hover:text-white uppercase">Servicios</a>
                        <a className="cursor-pointer text-gray-600 hover:text-white uppercase">Sobre nosotros</a>
                        <a className="cursor-pointer text-gray-600 hover:text-white uppercase">Contactanos</a>
                    </div>
                    <div className="flex flex-row space-x-8 items-center md:p-4 py-4">
                        <a>
                ...
                <hr className="border-gray-300 opacity-5"/>
                <p className="w-full text-center my-12 text-gray-600">   &copy; {new Date().getFullYear()} DEXEL DIGITAL EXCELLENCE. Todos los
            ...
            <a
                ...
                className="fixed bottom-5 right-5 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-blue-400 text-white shadow-blue-200 transition hover:-translate-y-0.5 hover:scale-[1.03] hover:bg-blue-300 md:h-16 md:w-16"
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="36" height="36" fill="currentColor"><g><path d="M128,24A104,104,0,0,0,36.18,176.88L24.83,210.93a16,16,0,0,0,20.24,20.24l34.05-11.35A104,104,0,1,0,128,24Zm0,192a87.87,87.87,0,0,1-44.06-11.81,8,8,0,0,0-6.54-.67L40,216,52.47,178.6a8,8,0,0,0-.66-6.54A88,88,0,1,1,128,216Z"></path></g></svg>
            </a>
    </footer>
);
}