    ...
    <main className="pt-28 pb-24 relative overflow-hidden">
      ...
      <section className="relative z-10 px-6">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-6 leading-tight text-slate-900 dark:text-white">{copy.title}</h1>
          <p className="text-lg md:text-xl text-slate-600 dark:text-gray-400 max-w-2xl mx-auto">{copy.subtitle}</p>
        </div>
      </section>
          ...
          {detailedServices.map((service, index) => {
            ...
            return (
              <article key={service.id ?? index} id={service.id} className="group">
                ...
                >
                  <div className="w-full md:w-1/2 rounded-2xl border border-slate-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-950/65 p-7 md:p-8">
                    ...
                    <h2 className="text-3xl md:text-[2rem] font-bold text-slate-900 dark:text-white mb-4 leading-tight">{service.title}</h2>
                    ...
                    <p className="text-slate-600 dark:text-gray-300 mb-6 leading-relaxed">{service.description}</p>
      ...
      <section className="relative z-10 px-6 pt-20">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">{copy.faqTitle}</h2>
            <p className="text-xl text-slate-600 dark:text-gray-400">{copy.faqSubtitle}</p>
          </div>
              ...
              return (
                ...
                >
                  <Button
                    ...
                    variant="ghost"
                    className="w-full h-auto p-6 justify-between text-left rounded-none hover:bg-slate-50 dark:hover:bg-zinc-800/50"
                  >
                  ...
                  {isOpen ? (
                    <div className="px-6 pb-6">
                      <p className="text-slate-600 dark:text-gray-300 leading-relaxed">{faq.answer}</p>
                    </div>
                  ) : null}
                </div>
              );
