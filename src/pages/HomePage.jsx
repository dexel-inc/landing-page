...
export default function HomePage({ copy, onNavigate }) {
  return (
    <>
      <section
        id="inicio"
        className="min-h-[100svh] flex flex-col justify-center items-center text-center px-4 relative pt-28 pb-10 md:py-4"
      >
        ...
        <div className="z-10 relative justify-center items-center flex flex-col my-4">
          ...
          <div className="mt-10 md:mt-16 flex flex-col items-center gap-3 md:gap-4">
            <div className="w-[1px] h-10 md:h-16 bg-gradient-to-b from-blue-500 to-transparent animate-pulse"></div>
